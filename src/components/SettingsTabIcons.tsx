...
//
// Ruch siedzi w CSS (src/styles.css, klatki settings-*) i włącza go atrybut
// data-playing. Rodzic przemontowuje ikonę przez key, więc kolejne kliknięcie
// w tę samą sekcję puszcza animację od nowa.
