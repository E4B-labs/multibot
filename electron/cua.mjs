...
//    EmbeddedCuaDriverHost so TCC grants attribute to MultiBot and the
//    driver inherits them. One prompt, named MultiBot, out of the box.
...
const HOST_BUNDLE_ID = "com.e4b-labs.multibot";
...
export async function startCua() {
  ...
  const wantEmbedded =
    app.isPackaged || process.env.MULTIBOT_CUA_EMBEDDED === "1";
