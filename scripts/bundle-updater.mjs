...
await build({
  // node_modules may be a worktree junction; anchor esbuild at its real parent
  // so generated comments never expose an absolute developer path.
  absWorkingDir: dirname(realpathSync(join(root, "node_modules"))),
